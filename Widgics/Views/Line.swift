	...
	public var body: some View {
		ZStack {
			if(self.showFull && self.showBackground){
				self.closedPath
					.fill(LinearGradient(gradient: Gradient(colors: [.blue]), startPoint: .bottom, endPoint: .top))
...
struct Line_Previews: PreviewProvider {
	...
	static var previews: some View {
		let visitors : [Float] = [12.3,23.0,900.0,-100.0]
		GeometryReader{ geometry in
			Line(data: ChartData(points: visitors), frame: .constant(geometry.frame(in: .local)), touchLocation: .constant(CGPoint(x: 100, y: 12)), showIndicator: .constant(true), minDataValue: .constant(nil), maxDataValue: .constant(nil))
